...
class UserCustomMealSerializer(serializers.ModelSerializer):
    ...
    protein = serializers.FloatField(source='protein_g')
    carbs = serializers.FloatField(source='carbs_g')
    fats = serializers.FloatField(source='fats_g')
...
class LocationAwareBaseMealSerializer(serializers.ModelSerializer):
    ...
    carbs = serializers.FloatField(source='carbs_g')
    fats = serializers.FloatField(source='fats_g')
    fiber = serializers.FloatField(source='fiber_g')
